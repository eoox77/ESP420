...
(library Library_1
	...
	(compDef "THVD1426DR" (originalName "THVD1426DR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "R") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "7" (pinName "B") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "A") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.ti.com/jp/lit/ds/symlink/thvd1426.pdf?ts=1676878246969&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252Fja-jp%252FTHVD1426")
		(attr "Height" "1.75 mm")
	)
